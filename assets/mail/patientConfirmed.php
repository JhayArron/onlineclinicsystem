<?php
  ...
  date_default_timezone_set('Asia/Manila');
    ...
    $subject = ''.strtoupper($business_name).'| CONFIRMED NOTIFICATION : '.strtoupper($email).' ';
    ...
    $message = '
      ...
      <head>
        <meta charset="UTF-8">
        <title>'.strtoupper($business_name).' | CONFIRMED NOTIFICATION</title>
      </head>
      <body>
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            ...
                            -->
                            <p>Hi '.$guardian.',</p>
                            <p>Were happy to let you know that your booking has been successfully confirmed.</p><br>
                          </td>
                        </tr>
                      </table>
                    </td>
