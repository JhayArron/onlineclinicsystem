<?php
  ...
  date_default_timezone_set('Asia/Manila');
    ...
    $subject = ''.strtoupper($business_name).'| ACCOUNT CREATED BY ADMIN NOTIFICATION : '.strtoupper($email).' ';
    ...
    $message = '
      ...
      <head>
        <meta charset="UTF-8">
        <title>'.strtoupper($business_name).' | ACCOUNT CREATED BY ADMIN NOTIFICATION</title>
      </head>
      <body>
                      ...
                      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                            ...
                            -->
                            <p>Hi '.$fullname.',</p>
                            <p>We created your account with the following credentials : </p><br>
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td class="content-block powered-by">
                        Powered by <a href="#">'.strtoupper($business_name).'</a>.
                      </td>
                    </tr>
                  </table>
                </div>
    ...
    try {
        ...
        // Sender & Recipient'.strtoupper($business_name).'
        $mail->setFrom('familyvilleofficial@gmail.com', $business_name); // Your email
