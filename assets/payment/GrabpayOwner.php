...
if($view == 'SPECIFICACCOUNTBOOK')
{
    ...
    $success = "https://onlineclinicsystem.familyvill.online/CLINIC_APP/account/admin/?view=".$view."&client_id=".$client_id."&message=success";
    $fail = "https://onlineclinicsystem.familyvill.online/CLINIC_APP/account/admin/?view=".$view."&client_id=".$client_id."&message=failed";
}
else
{
    $success = "https://onlineclinicsystem.familyvill.online/CLINIC_APP/account/admin/?view=".$view."&message=success";
    $fail = "https://onlineclinicsystem.familyvill.online/CLINIC_APP/account/admin/?view=".$view."&message=failed";
}
