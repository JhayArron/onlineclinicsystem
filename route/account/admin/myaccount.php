                 ...
                 <div class="col-md-12 mt-2">
                     ...
                     <div id="Web" class="tabcontent mb-5" style="display: none;">
                        <center>
                         ...
                         <hr />
                         <div class="mb-3 mt-3">
                           <a href="https://onlineclinicsystem.familyvill.online/CLINIC_APP/clinic/?company=<?php echo $account[0]['business_name']; ?>" id="copyLink">https://onlineclinicsystem.familyvill.online/CLINIC_APP/clinic/?company=<?php echo $account[0]['business_name']; ?></a>   
                         </div>
                    </div>
                 </div>
             </div>
